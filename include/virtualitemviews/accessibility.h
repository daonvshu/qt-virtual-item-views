...
/// current index.
class AccessibleVirtualItem : public QAccessibleInterface, public QAccessibleActionInterface
{
public:
    ...
    /// Row of the view the node belongs to (a table cell reports its row).
    QModelIndex rowIndex() const;
...
class AccessibleVirtualItemView : public QAccessibleInterface, public QAccessibleActionInterface
{
public:
