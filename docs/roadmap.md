...
（数据 / 状态正确性）与 Wave 3（虚拟化性能，含 P1-3/P1-4/P1-5）都已完成；剩下的 Wave 4
（Vertical widget header、`TablePaneSpec` 校验、事务化 restore、vertical header 状态、
orientation 校验、pin 的 offscreen 语义、树 visible 结构优化、CI）里只有 P1-14 是发布阻塞项。
